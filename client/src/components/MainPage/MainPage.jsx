  ...
  return (
    ...
    <div className='mainpage'> 
      ...
      <h3 className='animate__animated animate__zoomInDown hello hello-2'>Для начала </h3>
        ...
        :<>
        <div className='but-reg-auth'>
          <Button className='animate__animated animate__zoomInDown but-reg' variant="warning"><Nav.Link className='link-as' as={Link} to="/game">Начать играть</Nav.Link></Button>
        </div></>}
